// app/src/androidTest/java/com/cursoandroid/queermap/di/TestDispatchersModule.kt
...
import kotlinx.coroutines.test.StandardTestDispatcher // <-- CAMBIO AQUÍ
import kotlinx.coroutines.test.TestCoroutineScheduler // <-- Agrega si no está
